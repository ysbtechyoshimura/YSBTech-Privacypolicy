...
<body>
 <article>
  ...
  <h2>2.1 アプリケーションの利用状況の収集</h2></h2>
  <p><span id="me"></span>.</p>が配信するアプリでは、広告配信のためにGoogle AdMob、利用状況解析のためにGoogle Firebase Analyticsを使用する場合がございます。</p>
  ...
  <p>2.2 お問い合わせやご意見を頂く際の個人情報の収集</p>
